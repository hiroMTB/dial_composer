...
public:
    ...
    ofCoreEvents & events(){ return coreEvents; };
    shared_ptr<ofBaseRenderer> & renderer(){ return currentRenderer; };
    ...
    ~ofxCocoaGLViewWindowProxy(){
        cout << "kill ofxCocoaGLViewWindowProxy()" << endl;
    }
