...
static const int DT_RHYTHM_SHAPE_MAX_SLOT = 12;
static const int DT_QUANTIZE_RESOLUTION = 128;
static const int DT_BEAT_RESOLUTION = 128;		// hwo many steps per 1 beat
